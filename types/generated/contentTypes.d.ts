...
export interface ApiActionAction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['NO_COST', 'LOW_COST', 'INVESTMENT']> &
      Attribute.Required;
    impact: Attribute.Enumeration<['LOW', 'MEDIUM', 'HIGH']> &
      Attribute.Required;
    effort: Attribute.Enumeration<['EASY', 'AVERAGE', 'DIFFICULT']> &
      Attribute.Required;
    popular: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    type: Attribute.Enumeration<['PRODUCT', 'SERVICE', 'HABIT']> &
      Attribute.Required;
